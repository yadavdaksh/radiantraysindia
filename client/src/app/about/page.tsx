...
const FOUNDERS = [
  ...
  },
  {
    ...
    bio: "Daksh leads business development, client relations, and quality assurance at Radiant Rays. With deep understanding of GMP and ISO cleanroom standards, he has built strong partnerships with pharmaceutical manufacturers, biotech labs, and hospital facilities across India. His vision drives the company's commitment to precision engineering and post-sale support. ",
